...
export const magazineIssues: MagazineIssue[] = [
  {
    ...
    description:
      "Exploring how industries and societies adapted and thrived during challenging times, this issue focuses on resilience, innovation, and sustainable growth strategies.",
    highlights: [
    ...
    articles: [
      {
        ...
        excerpt:
          "An in-depth analysis of how businesses pivoted during the pandemic and emerged stronger...",
      },
      {
        title:
          "Green Recovery: Environmental Sustainability in Economic Growth",
        author: "Prof. James Chen",
        excerpt:
          "Examining the intersection of environmental consciousness and economic recovery...",
      },
    ],
    statistics: {
      totalArticles: 24,
  ...
  },
  {
    ...
    description:
      "A comprehensive exploration of the digital revolution transforming industries, education, and daily life, featuring insights from leading tech innovators and digital strategists.",
    highlights: [
    ...
    articles: [
      {
        ...
        excerpt:
          "A practical look at AI implementation across various industries...",
      },
      {
      ...
      },
      {
        ...
        excerpt:
          "How technology is reshaping education and learning experiences...",
      },
    ],
    statistics: {
      totalArticles: 28,
  ...
  },
  {
    ...
    description:
      "A special edition dedicated to sustainability, environmental consciousness, and building a better future for generations to come through innovative solutions and collaborative efforts.",
    highlights: [
    ...
    articles: [
      {
        ...
        excerpt:
          "Bridging the gap between environmental policy and practical implementation...",
      },
      {
        title: "Renewable Energy: The Path Forward",
        author: "Michael Brown",
        excerpt:
          "Exploring innovative renewable energy solutions and their global impact...",
      },
      {
        title: "Sustainable Entrepreneurship: Business for Good",
        author: "Laura Wilson",
        excerpt:
          "How young entrepreneurs are building sustainable business models...",
      },
    ],
    statistics: {
      totalArticles: 26,
